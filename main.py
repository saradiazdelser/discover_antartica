...
if __name__ == '__main__':
	...
	print('\033[1;97;101mERROR:\0330m Cannot be executed as module.')
	sys.exit(2)
...
def i_am_iron_main():
	...
	if ftt.the_format_is_strong_in_this_one(str(query))=='FA':
		...
		try: 
			...
			print ("\033[1;97;101mERROR:\0330m Something wrong while BLASTin'!")
			sys.exit(2)
		...
		try:
			...
			print ("\033[1;97;101mERROR:\0330m Something wrong while making phylogenetic tree'!")
			sys.exit(2)
		...
		try:
			...
			print ("\033[1;97;101mERROR:\0330m Something wrong while analyzing domains!")
			sys.exit(2)

	else:
		print("\033[1;97;101mERROR:\0330m Can't run the program with a non-valid query file!")
		sys.exit(2)
...
try: 
	...
	print('\033[1;97;101mERROR:\0330m Something went terribly wrong.')
