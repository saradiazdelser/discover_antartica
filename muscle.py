...
# This program also requires MUSCLE to work. If you don't have MUSCLE 
#+installed, you should check out how to do it here: 
...
# Tecnically, you could run it with Biopython, but it won't let you 
#+create a tree, so you'd have to do that part with the os module anyway. 
...
def run_muscle_run(fasta_file, aligned_file, tree_file):
    ...
    cmd2 = "muscle -maketree -in " + aligned_file + " -out " + tree_file +\
